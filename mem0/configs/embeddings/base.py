...
class BaseEmbedderConfig(ABC):
    ...
    def __init__(
        ...
        :param allowed_openai_params: OpenAI-compatible proxy parameters that may be forwarded, defaults to None
        :type allowed_openai_params: Optional[list[str]], optional
        ...
        self.allowed_openai_params = allowed_openai_params or []

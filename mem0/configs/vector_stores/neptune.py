...
as a vector store backend for YiQiao's memory layer.
"""
...
class NeptuneAnalyticsConfig(BaseModel):
    ...
    for storing and retrieving memory embeddings in YiQiao.

    Attributes:
        collection_name (str): Name of the collection to store vectors. The legacy default is retained for compatibility.

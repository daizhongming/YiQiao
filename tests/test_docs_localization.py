...
class DocumentationLocalizationTests(unittest.TestCase):
    ...
    def test_coverage_manifest_is_complete_and_self_describing(self):
        ...
        self.assertEqual(len(inventory.entries), 29)
        ...
        self.assertEqual(
            by_source["docs/yiqiao/RELEASE_0.2.0.md"].target,
            "docs/yiqiao/RELEASE_0.2.0.zh-CN.md",
        )
        self.assertEqual(
            by_source["docs/yiqiao/RELEASE_0.2.1.md"].target,
            "docs/yiqiao/RELEASE_0.2.1.zh-CN.md",
        )
        self.assertEqual(
            by_source["docs/yiqiao/RELEASE_1.0.0.md"].target,

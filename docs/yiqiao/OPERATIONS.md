...
| ---------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| Compose volume `postgres_db` | Users, API keys, settings, requests, exports, and vector data                 | Retained by `docker compose down`; deleted by `down -v` |
...
source `JWT_SECRET` and any required provider

...
def test_initialization(mock_clients):
    ...
    assert "yiqiao" in mock_search_client._client._config.user_agent_policy.add_user_agent.call_args[0]
    assert "yiqiao" in mock_index_client._client._config.user_agent_policy.add_user_agent.call_args[0]
...
def test_init_with_valid_api_key(mock_clients):
    ...
    mock_search_client._client._config.user_agent_policy.add_user_agent.assert_called_with("yiqiao")
    mock_index_client._client._config.user_agent_policy.add_user_agent.assert_called_with("yiqiao")

...
images with material redistribution requirements as reviewed on 2026-07-18.
The version constraints and resolved versions in `pyproject.toml`,
`server/requirements.txt`, `server/dashboard/package.json`, and
`server/dashboard/pnpm-lock.yaml` are authoritative for a particular build.
...
| ------------------------ | ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `python:3.12-slim`       | Python Software Foundation License; Debian packages under their individual licenses        | Forms the YiQiao API image base. Preserve `/usr/share/doc` copyright data and upstream image notices when redistributing.                                                                                                         |

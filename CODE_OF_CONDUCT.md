...
YiQiao community a harassment-free experience for everyone, regardless of age,
...
the contact method on the
[maintainer profile](https://github.com/daizhongming). If no private contact
method is available, use the repository's
[private advisory form](https://github.com/daizhongming/YiQiao/security/advisories/new)
and label the report as a Code of Conduct matter.

All complaints will be reviewed promptly and fairly. Community leaders must
respect the privacy and security of the reporter.

## Enforcement Guidelines

Community leaders will use these guidelines when determining consequences:

### 1. Correction

**Community Impact**: Inappropriate language or other behavior considered
...
**Consequence**: A warning with consequences for continued behavior and a
specified period of no interaction with the people involved. Violating these
...
the community. Violating the ban may lead to a permanent ban.

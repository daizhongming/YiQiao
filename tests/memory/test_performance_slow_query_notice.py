...
def test_performance_slow_query_blunt_flag_disable_does_not_capture_or_consume(notice_harness, variant, capsys):
    config, telemetry = notice_harness
...
def test_performance_slow_query_telemetry_disabled_does_not_touch_posthog_or_state(monkeypatch, capsys):

...
const translations: Record<string, string> = {
  ...
  "Approve new connections and manage access to this YiQiao workspace.":
    "批准新连接并管理对此 YiQiao 工作区的访问权限。",
  Authorize: "授权",
  Connections: "连接",
  Applications: "应用",
  "Authorize an application": "授权应用",
  "Enter the user code displayed by the application requesting access.":
    "输入请求访问的应用所显示的用户代码。",
  "User code": "用户代码",
  "Look up request": "查询请求",
  "Authorization request": "授权请求",
  "Approve connection": "确认授权",
  "Reject connection": "拒绝连接",
  "Revoke connection": "撤销授权",
  "Connection rejected": "已拒绝连接",
  ...
  "Application revoked": "应用已撤销",
  "Revoke application": "撤销应用",
  "Complete all application fields": "请完整填写所有应用字段",
  "Application management is unavailable": "应用管理不可用",
  "Failed to load connections": "加载连接失败",
  Scopes: "权限范围",
  Audience: "受众",
  "Approved scopes": "已批准权限",
  "Requested scopes": "请求的权限",
  Expires: "过期时间",
  approved: "已批准",
  connected: "已连接",
  expired: "已过期",
  revoked: "已撤销",
  denied: "已拒绝",
  "Connection approved": "已确认连接",
  "Connection revoked": "连接已撤销",
  "Clear any permission you do not want to grant.":
    "取消勾选任何你不想授予的权限。",
  "Approve selected scopes": "批准所选权限",
  "Reject connection?": "拒绝连接？",
  "The application will not receive access.": "该应用将不会获得访问权限。",
  Reject: "拒绝",
  "Active connections": "活动连接",
  "Review and revoke application access for this project.":
    "查看并撤销应用对此项目的访问权限。",
  "Refresh connections": "刷新连接",
  "Loading connections...": "正在加载连接...",
  "Your connections": "你的连接",
  "You have no connected applications.": "你尚未连接任何应用。",
  "Project connections": "项目连接",
  "No other project connections.": "没有其他项目连接。",
  "Recent access activity": "最近访问活动",
  "No recent access activity.": "暂无最近访问活动。",
  Application: "应用",
  Outcome: "结果",
  You: "你",
  "Revoke connection?": "撤销连接？",
  "This app will no longer be able to access the approved project data.":
    "此应用将无法再访问已批准的项目数据。",
  "Revoke all application access?": "撤销该应用的所有访问权限？",
  "All project grants for this application will be revoked.":
    "将撤销此应用在该项目中的所有授权。",
  "All of your grants for this application will be revoked.":
    "将撤销你授予此应用的所有权限。",
  "Revoke all": "全部撤销",
  "Register a public application": "注册公共应用",
  "Define the audiences and scopes this application may request.":
    "定义此应用可以请求的受众和权限。",
  "Client ID": "客户端 ID",
  "Display name": "显示名称",
  "Application name": "应用名称",
  "Allowed audiences": "允许的受众",
  "Allowed scopes": "允许的权限",
  "Separate multiple values with commas.": "多个值请用逗号分隔。",
  "Registered applications": "已注册应用",
  "Refresh applications": "刷新应用",
  "Loading applications...": "正在加载应用...",
  "No applications registered.": "尚未注册应用。",
  "Revoke application?": "撤销应用？",

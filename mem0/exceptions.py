...
"""Structured YiQiao exception classes with error codes, suggestions, and debug information.
...
and recovery in applications using YiQiao.
...
class MemoryError(Exception):
    ...
    This is the base class for all YiQiao-specific exceptions. It provides a structured
...
class AuthenticationError(MemoryError):
    ...
    Example:
        raise AuthenticationError(
            ...
            error_code="AUTH_001",
            suggestion="Please check your API key in the YiQiao dashboard"
        )
    """
...
class NetworkError(MemoryError):
    ...
    Example:
        raise NetworkError(
            ...
            debug_info={"timeout": 30, "endpoint": "http://127.0.0.1:8888"}
        )
    """
...
class ConfigurationError(MemoryError):
    ...
    Example:
        raise ConfigurationError(
            ...
            error_code="CFG_001",
            suggestion="Configure the required credential or endpoint and try again"
        )
    """
